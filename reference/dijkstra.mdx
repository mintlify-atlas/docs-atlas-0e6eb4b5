---
title: "dijkstra_simple — Weighted Single-Source Shortest Path"
sidebarTitle: "dijkstra_simple"
description: "dijkstra_simple computes the shortest path between two graph vertices, respects blocked edges, and returns distances, predecessors, and the path."
---
