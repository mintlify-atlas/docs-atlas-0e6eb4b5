---
title: "Star Object Properties and Effect Reference"
sidebarTitle: "Star Properties"
description: "Each star object in the JSON defines a graph vertex with gameplay effects. This reference covers every star field, its type, and its impact on the donkey during traversal."
---
...
<ParamField body="hypergiant" type="boolean">
  When `true`, visiting this star triggers a teleportation dialog and automatically grants the donkey **+10 health** (capped at 100). Hypergiant stars are rendered in **gold** in the graph UI, making them visually distinct from standard stars.
</ParamField>
...
<Tip>
  Hypergiant stars (rendered in gold) grant +10 health on visit and open a teleportation dialog that lets you jump to a distant part of the graph instantly. Because they also tend to carry strong `healthImpact` bonuses through research, routing through a hypergiant can rescue a donkey that would otherwise die mid-path — plan your routes to pass through them when health is low.
</Tip>
