---
title: "Constellation JSON File Format and Schema"
sidebarTitle: "JSON Schema"
description: "The JSON file defines the entire graph topology, donkey starting state, and simulation parameters. Learn the top-level schema and how to structure multiple constellations."
---
