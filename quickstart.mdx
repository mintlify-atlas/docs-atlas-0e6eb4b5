---
title: "Get Started with Constellations"
...
| `burroenergiaInicial` | number | The donkey's starting energy level (0–100). Depleted by `distance × 0.1` per edge traversal. |
| `estadoSalud` | string | Initial health label — `"Excellent"`, `"Good"`, `"Bad"`, or `"Dying"`. Maps to a starting `health_percent` value. |
